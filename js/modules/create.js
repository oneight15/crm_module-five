  ...
  newTr.insertAdjacentHTML('beforeend', `
    <tr class="table__row">
      <td class="table__cell table__cell_id">
        ${obj.id ?? elem.idValue.textContent}</td>
      ...
      <td class="table__cell table__cell_icons">
        <button class="table-icon table-icon_type_pic" data-pic="https://i01.fotocdn.net/s126/32dd73dec4b0a539/public_pin_m/2856024525.jpg">
